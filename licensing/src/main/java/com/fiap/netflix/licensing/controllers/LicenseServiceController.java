package com.fiap.netflix.licensing.controllers;
...
import com.fiap.netflix.licensing.services.LicenseService;

@RestController
@RequestMapping(value = "v1/netflix/{organizationId}/licenses")
